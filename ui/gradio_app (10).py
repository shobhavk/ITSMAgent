...
/* Overview - Executive Summary card/button. */
                ...
                with gr.Tabs(elem_id="main-tabs") as main_tabs:
                    with gr.Tab("Overview", id=0):
                        ...
                        with gr.Column(elem_classes=["dash-card"], elem_id="exec-summary-card"):
                            ...
                            exec_summary_btn = gr.Button("Generate Executive Summary", variant="primary", size="sm")
                            exec_summary_output = gr.Markdown(
                                "Run an analysis, then click **Generate Executive Summary** for a "
